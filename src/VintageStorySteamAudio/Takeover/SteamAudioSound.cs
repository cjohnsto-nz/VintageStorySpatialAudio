...
/// </summary>
public sealed class SteamAudioSound : ILoadedSound
{
    ...
    internal SteamAudioSound(AudioSession session, SoundParams soundParams, Func<AudioAsset?> resolveAsset, int channelsHint)
    {
