...
internal sealed class SpeakerTest(AudioEngine engine) : IDisposable
{
    ...
    public string Start(ICoreClientAPI clientApi)
    {
        ...
        return string.Create(
            ...
            $"Speaker test on {SpatialAudioModSystem.DescribeOutput(stats)}, {stats.Channels} channels: " +
            $"{Steps.Length} bursts, {StepMs / 1000.0:0.#} s apart. .spatialaudio speakertest stop ends it.");
    }
