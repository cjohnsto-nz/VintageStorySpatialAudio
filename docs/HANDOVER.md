...
- **What is left is the reflections:** 24.2 ms per tick on three threads is most of Steam Audio's 75 %, and 10 places were kept live for 2 audible sounds (places are held 30 s after their last sound, ADR 0012), so walking simulates ground already left behind.
