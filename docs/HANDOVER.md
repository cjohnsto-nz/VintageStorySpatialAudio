...
- **Next:** Chris runs the remaining spots (cave, forest) and fills the table; then whatever the numbers say (thread priorities, Steam Audio thread count, main-thread hot spots), then the rest of Phase 8: entity-bound source tracking review, compatibility modes, presets, docs, packaging, the 2-hour soak.
