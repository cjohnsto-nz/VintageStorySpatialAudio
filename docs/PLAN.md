...
- **As built (ADR 0011):** one listener reverb (early reflections and tail) that every sound feeds by the louder of its direct path and its path round obstacles through the air; voices' own reflections optional, off by default.
