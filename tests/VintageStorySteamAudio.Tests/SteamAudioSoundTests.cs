...
/// <summary>
/// <see cref="SteamAudioSound"/> against the real engine, rendered offline: the ILoadedSound
/// contract vanilla code relies on.
/// </summary>
[Collection(NativeEngineGroup.Name)]
public sealed class SteamAudioSoundTests
{
    ...
    public void A_new_sound_has_stopped_and_starts_on_request()
    {
        ...
        SteamAudioSound sound = rig.Sound(loop: true);
    ...
    public void A_sound_whose_data_is_still_loading_plays_once_it_arrives()
    {
        ...
        SteamAudioSound sound = rig.Session.CreateSound(soundParams, () => ready, 1);
    ...
    {
        using var rig = new Rig();
        SteamAudioSound sound = rig.Sound(loop: true, type: EnumSoundType.Music);
        sound.Start();
    ...
    private sealed class Rig : IDisposable
    {
        ...
        public SteamAudioSound Sound(bool loop = false, EnumSoundType type = EnumSoundType.Sound) =>
