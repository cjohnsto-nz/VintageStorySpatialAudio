...
public sealed class NativeLayoutTests
{
    ...
    public void VoiceDesc_and_status_match_header()
    {
        ...
        Assert.Equal(52, (int)Marshal.OffsetOf<VsaVoiceDesc>(nameof(VsaVoiceDesc.HighPassHz)));
    ...
    public unsafe void Scene_structs_match_header()
    {
        ...
        Assert.Equal(72, sizeof(VsaAudibleVoice));
        Assert.Equal(40, (int)Marshal.OffsetOf<VsaAudibleVoice>("Position"));
        Assert.Equal(52, (int)Marshal.OffsetOf<VsaAudibleVoice>("Arrival"));
