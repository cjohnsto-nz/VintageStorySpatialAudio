...
public sealed class HighPassFilterTests
{
    ...
    public void By_default_every_footstep_is_filtered_whoever_recorded_it_and_nothing_else()
    {
        ...
        Assert.Equal(150f, filters.For("game:sounds/creature/wolf/footsteps/dirt/footstep-wolf-dirt3.ogg"));
        Assert.Equal(150f, filters.For("creaturefootsteps:sounds/drifterstep5"));
        Assert.Equal(150f, filters.For("creaturefootsteps:sounds/compatibility/feverstonewilds/golem-footstep2"));
        Assert.Equal(150f, filters.For("creaturefootsteps:sounds/footstep-hooved-dirt1"));
